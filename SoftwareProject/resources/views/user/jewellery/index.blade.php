...
@section('content')
    ...
    <div class="contain d-flex">
        <div class="row me-2">
            <div class="dropdown mb-2">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="{{ route('user.jewellery.index') }}">Rings</a></li>
        ...
        <div class="row">
            <div class="dropdown mb-2">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="{{ route('jewellery.index') }}">Sterling Silver</a></li>
    ...
    <div class="card rounded-0 border-0 bg-transparent" style="width: 17rem";>
        <img src="{{ asset('storage/images/' . $piece->img) }}" class="card-img-top rounded-0 border border-dark" alt="...">
