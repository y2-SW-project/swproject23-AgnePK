    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="my-6 p-6 bg-white border-b border-gray-200 shadow-sm sm:rounded-lg">
                <form action="{{ route('jewellery.edit', $jewellery) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <x-textarea
                        ...
                        class="w-full mt-6"
                        :value="@old('description', $Jewellery->description)">
                    </x-textarea>
                    ...
                    <x-text-input
                        ...
                        autocomplete="off"
                        :value="@old('price', $Jewellery->price)">
                    </x-text-input>
                    @error('price')
                    <div class="text-red-600 text-sm">{{ $message }}</div>
                    @enderror
                    ...
                    <x-text-input
                        ...
                        class="w-full"
                        autocomplete="off"
                        :value="@old('category', $Jewellery->category)">
                    </x-text-input>
                    @error('category')
                    <div class="text-red-600 text-sm">{{ $message }}</div>
                    @enderror
                    ...
                    <x-text-input
                        ...
                        class="w-full"
                        autocomplete="off"
                        :value="@old('material', $Jewellery->material)">
                    </x-text-input>
                    @error('material')
                    <div class="text-red-600 text-sm">{{ $message }}</div>
                    @enderror
